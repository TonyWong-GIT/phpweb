...
function update(){
  ...
  type = document.getElementById('type-info').value;
  keyword = document.getElementById('keyword-info').value;
  window.location.href="keyword_update.php?task="+task+"&type="+type+"&keyword="+keyword+"";
};
</script>
...
?>
		...
		<div class="setup-window-sys">
			<div class="setup-window-sys-head">系统配置</div>
			<div class="setup-window-sys-content"></div>
			<!--  此处显示系统盘配置的相关信息 -->
		</div>
	...
	<div class="setup-window-info">
		...
		天眼舆情系统是哈工大网络技术研究所主打产品之一，具有对互联网全访位舆情分析能力，可以全面满足公司企业政府机关的各方需要。 哈工大（威海）网络技术研究所（Institute of Network Technology，INET），简称网络所，创建于2010年，是在我国著名领域专家的指导与帮助下，以及学校的大力支持下成立的。 研究所现有在校全职教师6人，其中硕士生指导教师2人，在校学生40余人。研究所主要研究方向包括计算机网络信息对抗，网络与信息安全，物联网安全技术，虚拟化与可信计算，网络媒体计算等，研究基础雄厚，成果卓越。近年来，该研究所共承担国家计划项目2项、国家自然科学基金1项、省科技攻关项目1项，省自然科学基金项目1项，横向课题10余项。在国内外重要期刊发表文章40余篇。业已形成一支目标明确，技术基础过硬，能够攻坚的青年科研队伍。
		</p>
		<!--  此处显示系统盘配置的相关信息 -->
		</div>
	</div>
