...
*/
  ...
  echo '<a href=\'special.php?task='.$task.'&type='.$type.'&special_flag=1\'  value="specialurl" class="easyui-linkbutton">消失URL</a>&nbsp;';
  echo '<a href=\'special.php?task='.$task.'&type='.$type.'&special_flag=1\'  value="specialurl" class="easyui-linkbutton">出现URL</a>&nbsp;';
