...
*/
  ...
  if(strpos(substr($chart_date_start,4),'0') == 0){
	$chart_month = substr($chart_date_start,5,1);
  }else{
	$chart_month = substr($chart_date_start,4,2);
  }
  if(strpos(substr($chart_date_start,6),'0') == 0){
  ...
  if(strpos(substr($chart_date_end,4),'0') == 0){
	$chart_month = substr($chart_date_end,5,1);
  }else{
	$chart_month = substr($chart_date_end,4,2);
  }
  if(strpos(substr($chart_date_end,6),'0') == 0){
